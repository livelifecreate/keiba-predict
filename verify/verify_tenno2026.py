"""
天皇賞（春）2026（2026/5/3 京都芝3200m G1 15頭）再検証
...
ENTRIES_RAW = [
    ...
    (1,  4,  7, "クロワデュノール",  "牡4", "58", "北村友一",  "2022105102"),
    (2,  8, 15, "ヴェルテンベルク",  "牡6", "58", "松若風馬",  "2020103060"),
    (3,  2,  3, "アドマイヤテラ",    "牡5", "58", "武豊",      "2021105369"),
    (4,  3,  4, "アクアヴァーナル",  "牝5", "56", "松山弘平",  "2021105433"),
    (5,  7, 12, "ヘデントール",      "牡5", "58", "ルメール",  "2021105521"),
    (6,  6, 11, "タガノデュード",    "牡5", "58", "レーン",    "2021106548"),
    (7,  5,  8, "シンエンペラー",    "牡5", "58", "岩田望来",  "2021110048"),
    (8,  7, 13, "ミステリーウェイ",  "セ8", "58", "松本大輝",  "2018104638"),
    (9,  1,  1, "ヴェルミセル",      "牝6", "56", "鮫島克駿",  "2020103945"),
    (10, 6, 10, "マイネルカンパーナ","牡6", "58", "津村明秀",  "2020105798"),
    (11, 2,  2, "サンライズソレイユ","牡5", "58", "池添謙一",  "2021105104"),
    (12, 3,  5, "ケイアイサンデラ",  "セ6", "58", "藤懸貴志",  "2020104881"),
    (13, 5,  9, "プレシャスデイ",    "牡4", "58", "吉村誠之",  "2022104859"),
    (14, 8, 14, "ホーエリート",      "牝5", "56", "戸崎圭太",  "2021104855"),
    (15, 4,  6, "エヒト",            "牡9", "58", "川田将雅",  "2017100464"),
]

RACE_DATE_CUTOFF = "2026/05/03"
...
def main():
    ...
    out = "/Users/du/Documents/競馬予想システム/score_202608030411_京都_天皇賞春.csv"
