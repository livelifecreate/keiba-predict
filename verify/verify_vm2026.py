"""
ヴィクトリアマイル2026（2026/5/17 東京芝1600m 18頭）再検証
...
ENTRIES_RAW = [
    ...
    (1,  6, 12, "エンブロイダリー",   "牝4", "56.0", "ルメール",  "2022105185"),
    (2,  4,  8, "カムニャック",       "牝4", "56.0", "川田将雅",  "2022105402"),
    (3,  4,  7, "クイーンズウォーク", "牝5", "56.0", "西村淳也",  "2021105414"),
    (4,  2,  4, "エリカエクスプレス", "牝4", "56.0", "武豊",      "2022103205"),
    (5,  5,  9, "ココナッツブラウン", "牝6", "56.0", "北村友一",  "2020101607"),
    (6,  8, 16, "ニシノティアモ",     "牝5", "56.0", "津村明秀",  "2021100244"),
    (7,  3,  6, "ラヴァンダ",         "牝5", "56.0", "岩田望来",  "2021107098"),
    (8,  7, 14, "ジョスラン",         "牝4", "56.0", "戸崎圭太",  "2022104767"),
    (9,  2,  3, "マピュース",         "牝4", "56.0", "ゴンサレス","2022105467"),
    (10, 7, 13, "カナテープ",         "牝7", "56.0", "松山弘平",  "2019105293"),
    (11, 6, 11, "ボンドガール",       "牝5", "56.0", "丹内祐次",  "2021107179"),
    (12, 8, 17, "パラディレーヌ",     "牝4", "56.0", "坂井瑠星",  "2022103546"),
    (13, 7, 15, "アイサンサン",       "牝4", "56.0", "幸英明",    "2022103875"),
    (14, 3,  5, "ケリフレッドアスク", "牝4", "56.0", "ディーン",  "2022102296"),
    (15, 1,  2, "ワイドラトゥール",   "牝5", "56.0", "横山武史",  "2021104434"),
    (16, 8, 18, "チェルヴィニア",     "牝5", "56.0", "レーン",    "2021105643"),
    (17, 1,  1, "カピリナ",           "牝5", "56.0", "横山典弘",  "2021104073"),
    (18, 5, 10, "ドロップオブライト", "牝7", "56.0", "松若風馬",  "2019105806"),
]

RACE_DATE_CUTOFF = "2026/05/17"
...
def main():
    ...
    out = "/Users/du/Documents/競馬予想システム/score_202605020811_東京_ヴィクトリアマイル.csv"
