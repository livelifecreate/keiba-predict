"""
京都新聞杯2026（2026/5/9 京都芝2200m G2 16頭）再検証
...
ENTRIES_RAW = [
    ...
    (1,  3,  5, "コンジェスタス",     "牡3", "57", "西村淳也",  "2023106963"),
    (2,  8, 15, "ベレシート",         "牡3", "57", "北村友一",  "2023106983"),
    (3,  3,  6, "ラディアントスター",  "牡3", "57", "池添謙一",  "2023107250"),
    (4,  5, 10, "サヴォアフェール",   "牡3", "57", "松山弘平",  "2023105645"),
    (5,  2,  3, "メイショウテンク",   "牡3", "57", "団野大成",  "2023105021"),
    (6,  4,  7, "カムアップローゼス", "牡3", "57", "鮫島克駿",  "2023104386"),
    (7,  1,  2, "エムズビギン",       "牡3", "57", "川田将雅",  "2023107127"),
    (8,  7, 13, "ニホンピロロジャー", "牡3", "57", "国分恭介",  "2023102994"),
    (9,  5,  9, "カフジエメンタール", "牡3", "57", "吉村誠之",  "2023103899"),
    (10, 8, 16, "アクセス",           "牡3", "57", "岩田望来",  "2023100947"),
    (11, 4,  8, "バドリナート",       "牡3", "57", "坂井瑠星",  "2023107278"),
    (12, 2,  4, "ティラーノ",         "牡3", "57", "田山旺佑",  "2023101855"),
    (13, 6, 12, "キンググローリー",   "牡3", "57", "幸英明",    "2023100021"),
    (14, 1,  1, "アーレムアレス",     "牡3", "57", "菱田裕二",  "2023105223"),
    (15, 6, 11, "ブリガンティン",     "牡3", "57", "原優介",    "2023106490"),
    (16, 7, 14, "ステラスペース",     "牡3", "57", "武藤雅",    "2023104346"),
]

RACE_DATE_CUTOFF = "2026/05/09"
...
def main():
    ...
    out = "/Users/du/Documents/競馬予想システム/score_202608030511_京都_京都新聞杯.csv"
